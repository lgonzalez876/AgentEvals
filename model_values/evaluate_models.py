...
def setup_output_directory(run_name):
    ...
    output_dir = project_root / "output" / "model_values" / run_name
...
async def ambiguous_values_eval_async(
...
def ambiguous_values_eval(
    ...
    asyncio.run(ambiguous_values_eval_async(description_1, description_2, num_iters, skip_bias_check, run_name))


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run values evaluation on language models")
